...
class CompGCNConvBasis(MessagePassing):
	def __init__(self, in_channels, out_channels, num_rels, num_bases, ratio=None, alpha=None, act=lambda x:x, cache=True, params=None):
		super(self.__class__, self).__init__(out_channels=out_channels, ratio=ratio, alpha=alpha)
