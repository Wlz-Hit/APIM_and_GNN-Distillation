...
def dump_all_entities(examples, out_path, id2text: dict):
    ...
    for ex in examples:
        ...
        if ex['relation'] not in relations2id:
            relations2id[ex['relation']] = len(relations2id)
    ...
    json.dump(relations2id, open('{}/relations2id.json'.format(os.path.dirname(out_path)), 'w', encoding='utf-8'),  
