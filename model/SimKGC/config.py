...
parser.add_argument('--finetune-t', action='store_true', default=False,
...
parser.add_argument('--class-num', default=100, type=int, help='number of classes')
parser.add_argument('--model-plus', action='store_true', default=False, help='use model plus')
parser.add_argument('--topk', type=int, default=5, help='the number of topk classes for entity to keep')
parser.add_argument('--use-possibility-mask', action='store_true', default=False, help='use context for entity representation')
parser.add_argument('--alpha', type=float, default=0.5, help='the weight for possibility loss')
parser.add_argument('--possibility', action='store_true', default=False, help='whether to use possibility codebook')
parser.add_argument('--candidate-num', type=int, default=20, help='the number of candidates for eath entity')
parser.add_argument('--rerankn', type=int, default=2, help='the number of re-ranking entities')
